...
#include "RegistryRe.h"
#include "RegistrySet.h"
#include <Windows.h>
#include <mysql.h>
#include <string>
#include <iostream>
...
namespace FinalProject {
	...
	/// Registry 的摘要
	/// </summary>
	public ref class Registry : public System::Windows::Forms::Form
	{
	public:
		Registry(void)
		{
			...
			else
			{
				...
				while (i <= i2)
				{
					...
					MyDB.setCounter(i);
					if (MyDB.selectSQL_Counter(k1, k2, k2) == "")
					{
						i++;
					}
					else
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button5->Text = L"View the Registry";
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &Registry::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Text = L"Delete the Registry";
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &Registry::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Text = L"Rewrite the Registry";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &Registry::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Text = L"Add the Registry";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &Registry::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Registry::button1_Click);
			// 
			// label2
			// 
			...
			this->label2->Text = L"---------------------------------------------------------------------------------"
				L"---------------------------------------";
			this->label2->Click += gcnew System::EventHandler(this, &Registry::label2_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Registry number :";
			this->label1->Click += gcnew System::EventHandler(this, &Registry::label1_Click);
			// 
			// comboBox1
			// 
			...
			this->comboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &Registry::comboBox1_SelectedIndexChanged);
			// 
			// Registry
			// 
			...
			this->Name = L"Registry";
			this->ShowIcon = false;
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Registry";
			this->Load += gcnew System::EventHandler(this, &Registry::Registry_Load);
...
#pragma endregion
	...
	private: System::Void button5_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		FinalProject::RegistryView^sp = gcnew FinalProject::RegistryView;
		sp->ShowDialog();
		this->Close();
	...
	private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		funtion_DB MyDB;
		MyDB.setCounter(En);
		FinalProject::RegistryRe^sp = gcnew FinalProject::RegistryRe;
		sp->ShowDialog();
		this->Close();
	}
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
	FinalProject::RegistrySet^sp = gcnew FinalProject::RegistrySet;
	sp->ShowDialog();
	this->Close();
}
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	string k2 = "Rnumber";
	string k3 = in;
	if (MyDB.deleteSQL(k1, k2, in) == false)
	{
...
private: System::Void Registry_Load(System::Object^  sender, System::EventArgs^  e) {
}
};
}
